    ...
    pub fn solve(
        ...
        for idx in 0..self.mazes.len() {
            if idx > 0 {
                ...
                self.mazes[idx - 1].draw(screen, false, false, false, false, false);
            }
            // Solve the maze.
            ...
            self.mazes[idx].draw(screen, false, false, false, false, false);
            ...
            for idx_other in (idx + 1)..self.mazes.len() {
                ...
                self.mazes[idx_other].draw(screen, false, false, false, false, false);
            }
